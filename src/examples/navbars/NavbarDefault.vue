                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-animation dropdown-md dropdown-md-responsive p-3 border-radius-lg mt-0 mt-lg-3"
                                ...
                                <ul class="list-group">
                                    ...
                                    <li
                                        ...
                                        <div class="dropdown-menu mt-0 py-3 px-2 mt-3">
                                            ...
                                            <RouterLink class="dropdown-item ps-3 border-radius-md mb-1"
                                                :to="{ name: 'presentation' }">
                                                Button Groups </RouterLink>
                                            <RouterLink class="dropdown-item ps-3 border-radius-md mb-1"
                                                :to="{ name: 'presentation' }">
                                                Dropdowns </RouterLink>
                                            <RouterLink class="dropdown-item ps-3 border-radius-md mb-1"
                                                :to="{ name: 'presentation' }">
                                                Progress Bars </RouterLink>
                                            <RouterLink class="dropdown-item ps-3 border-radius-md mb-1"
                                                :to="{ name: 'presentation' }">
                                                Toggles </RouterLink>
                                            <RouterLink class="dropdown-item ps-3 border-radius-md mb-1"
                            ...
                            <div class="row d-lg-none">
                                <div class="col-md-12">
                                    ...
                                    <RouterLink class="dropdown-item ps-3 border-radius-md mb-1"
                                        :to="{ name: 'presentation' }"> Navbars
                                    </RouterLink>
                                    <RouterLink class="dropdown-item ps-3 border-radius-md mb-1"
                                        :to="{ name: 'presentation' }"> Nav
                                        Tabs </RouterLink>
                                    <RouterLink class="dropdown-item ps-3 border-radius-md mb-1"
                                        :to="{ name: 'presentation' }">
                                        Pagination </RouterLink>
                                    <div class="d-flex mb-2 mt-3">
                                        <div class="w-100 d-flex align-items-center justify-content-between">
                                            <div>
                                                <h6
                                    ...
                                    <RouterLink class="dropdown-item ps-3 border-radius-md mb-1"
                                        :to="{ name: 'presentation' }"> Inputs
                                    </RouterLink>
                                    <RouterLink class="dropdown-item ps-3 border-radius-md mb-1"
                                        :to="{ name: 'presentation' }"> Forms
                                    </RouterLink>
                                    <div class="d-flex mb-2 mt-3">
                                        <div class="w-100 d-flex align-items-center justify-content-between">
                                            <div>
                                    ...
                                    <RouterLink class="dropdown-item ps-3 border-radius-md mb-1"
                                        :to="{ name: 'presentation' }"> Alerts
                                    </RouterLink>
                                    <RouterLink class="dropdown-item ps-3 border-radius-md mb-1"
                                        :to="{ name: 'presentation' }"> Modals
                                    </RouterLink>
                                    <RouterLink class="dropdown-item ps-3 border-radius-md mb-1"
                                        :to="{ name: 'presentation' }">
                                        Tooltips & Popovers </RouterLink>
                                    ...
                                    <RouterLink class="dropdown-item ps-3 border-radius-md mb-1"
                                        :to="{ name: 'presentation' }"> Avatars
                                    </RouterLink>
                                    <RouterLink class="dropdown-item ps-3 border-radius-md mb-1"
                                        :to="{ name: 'presentation' }"> Badges
                                    </RouterLink>
                                    <RouterLink class="dropdown-item ps-3 border-radius-md mb-1"
                                        :to="{ name: 'presentation' }">
                                        Breadcrumbs </RouterLink>
                                    <RouterLink class="dropdown-item ps-3 border-radius-md mb-1"
                                        :to="{ name: 'presentation' }"> Buttons
                                    </RouterLink>
                                    <RouterLink class="dropdown-item ps-3 border-radius-md mb-1"
                                        :to="{ name: 'presentation' }"> Button
                                        Groups </RouterLink>
                                    <RouterLink class="dropdown-item ps-3 border-radius-md mb-1"
                                        :to="{ name: 'presentation' }">
                                        Dropdowns </RouterLink>
