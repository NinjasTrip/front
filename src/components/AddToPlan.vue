        ...
        <div class="card d-flex blur justify-content-center shadow-lg my-sm-0 my-sm-6 mt-8 mb-5">
          ...
          <div class="card-body">
            <p class="pb-3">
              ...
              please email fund88@naver.com or contact using our
              contact form.
            </p>
            <form id="contact-form" method="post" autocomplete="off" @submit.prevent="updateStore">
              ...
              <div class="text-center mt-3">
                <MaterialButton variant="gradient" color="secondary" class="mx-2">Add Destination to my plan
                </MaterialButton>
                <MaterialButton variant="gradient" color="secondary" class="mx-2 " @click="emitClose">Close
                </MaterialButton>
              </div>
            </form>
          </div>
